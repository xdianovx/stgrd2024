            ...
            <div class="row g-2">
                <div class="col-sm-4">
                    <div class="search-box">
                        <form class="d-flex" action="{{ route('admin.cities.search') }}" method="get">
                            @csrf
                ...
                <div class="col-sm-auto ms-auto">
                    <div class="list-grid-nav hstack gap-1">
                        ...
                        <a href="{{ route('admin.cities.create') }}" class="btn btn-success addMembers-modal">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="live-preview">
                            ...
                            <table class="table align-middle table-nowrap mb-0">
                                ...
                                <tbody>
                                    @forelse ($cities as $item)
                                        <tr>
                                            <td>{{ $item->id }}</td>
                                            <td><a href="{{ route('admin.cities.show', $item->slug) }}">{{ $item->title }}</a></td>
                                            <td>{{ $item->slug }}</td>
                                            ...
                                            <td>
                                                ...
                                                <div class="dropdown d-inline-block">
                                                    ...
                                                    <ul class="dropdown-menu dropdown-menu-end" style="">
                                                        <li><a href="{{ route('admin.cities.show', $item->slug) }}"
                                            ...
                                            <div class="modal-dialog modal-dialog-scrollable" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-footer">
                                                        ...
                                                        <form
                                                            action="{{ route('admin.cities.destroy', $item->slug) }}"
                                                            method="POST">
                                                            @csrf
                                                            @method('DELETE')
                        ...
                        @if ($cities->links()->paginator->hasPages())
                            {{ $cities->links() }}
                        @endif
                    </div>
                </div>
