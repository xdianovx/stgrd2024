            ...
            <div class="row g-2">
                <div class="col-sm-4">
                    <div class="search-box">
                        <form class="d-flex" action="{{ route('admin.contacts.search') }}" method="get">
                            @csrf
                ...
                <div class="col-sm-auto ms-auto">
                    <div class="list-grid-nav hstack gap-1">
                        ...
                        <a href="{{ route('admin.contacts.create') }}" class="btn btn-success addMembers-modal">
                            ...
                            <table class="table align-middle table-nowrap mb-0">
                                <thead class="table-light">
                                    <tr>
                                        ...
                                        <th scope="col">{{__('admin.field_office_type')}}</th>
                                        <th scope="col">{{__('admin.field_city')}}</th>
                                ...
                                <tbody>
                                    @forelse ($contacts as $item)
                                        <tr>
                                            <td>{{ $item->id }}</td>
                                            <td><a href="{{ route('admin.contacts.show', $item->id) }}">{{ $item->title }}</a></td>
                                            <td>{{ $item->office_type == 'main' ? 'Главный офис' : 'Филиал' }}</td>
                                            ...
                                            <td>
                                                ...
                                                <div class="dropdown d-inline-block">
                                                    ...
                                                    <ul class="dropdown-menu dropdown-menu-end" style="">
                                                        <li><a href="{{ route('admin.contacts.show', $item->id) }}"
                                            ...
                                            <div class="modal-dialog modal-dialog-scrollable" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-footer">
                                                        ...
                                                        <form
                                                            action="{{ route('admin.contacts.destroy', $item->id) }}"
                                                            method="POST">
                                                            @csrf
                                                            @method('DELETE')
