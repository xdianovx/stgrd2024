            ...
            <div class="row g-2">
                ...
                <div class="col-sm-auto ms-auto">
                    <div class="list-grid-nav hstack gap-1">
                        ...
                        <a href="{{ route('admin.news.create') }}" class="btn btn-success addMembers-modal">
                                ...
                                <tbody>
                                    @forelse ($news as $item)
                                        <tr>
                                            ...
                                            <td><a href="{{ route('admin.news.show', $item->slug) }}">{{ $item->title }}</a></td>
                                            <td>{{ $item->slug }}</td>
                                            ...
                                            <td>
                                                ...
                                                <div class="dropdown d-inline-block">
                                                    ...
                                                    <ul class="dropdown-menu dropdown-menu-end" style="">
                                                        <li><a href="{{ route('admin.news.show', $item->slug) }}"
                                            ...
                                            <div class="modal-dialog modal-dialog-scrollable" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-footer">
                                                        ...
                                                        <form
                                                            action="{{ route('admin.news.destroy', $item->slug) }}"
                                                            method="POST">
                                                            @csrf
                                                            @method('DELETE')
