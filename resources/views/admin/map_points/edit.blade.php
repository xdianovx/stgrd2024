        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header align-items-center d-flex">
                    <h4 class="card-title mb-0 flex-grow-1">{{ __('admin.edit_map_point_card_title') }} {{ $item->type }}
                    </h4>
                </div>
            </div>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="live-preview">
                        <form action="{{ route('admin.projects.map_point_update', [$project_slug, $project_block_slug, $item]) }}" method="POST"
                          ...
                          <div class="col-xxl-6 col-md-6">
                            <div>
                                ...
                                <input type="text" value="{{ $item->coordinates_latitude }}" class="form-control"
                        ...
                        <div class="col-xxl-6 col-md-6">
                          <div>
                              ...
                              <input type="text" value="{{ $item->coordinates_longitude }}" class="form-control"
