        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header align-items-center d-flex">
                    <h4 class="card-title mb-0 flex-grow-1">{{ __('admin.edit_management_card_title') }} {{ $item->title }}
                    </h4>
            ...
            @endif
                ...
                <div class="card-body">
                    <div class="live-preview">
                        <form action="{{ route('admin.managements.update', $item->id) }}" method="POST"
                            ...
                            <div class="row gy-4">
                                ...
                                <div class="col-xxl-6 col-md-6">
                                    <div>
                                        <label for="valueInput" class="form-label">{{ __('admin.field_position') }} *</label>
                                        <input type="text" value="{{ $item->position }}" class="form-control"
                                            id="valueInput" name="position"
                                            placeholder="{{ __('admin.placeholder_text') }}">
                                    </div>
                                </div>
                                <div class="col-xxl-6 col-md-6">
                                  <div>
                                      <label for="valueInput" class="form-label">{{ __('admin.field_phone') }} *</label>
                              ...
                              <div class="col-xxl-6 col-md-6">
                                <div>
                                    <label for="valueInput" class="form-label">{{ __('admin.field_email') }} *</label>
