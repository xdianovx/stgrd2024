            ...
            <div class="row g-2">
                <div class="col-sm-4">
                    <div class="search-box">
                        <form class="d-flex" action="{{ route('admin.managements.search') }}" method="get">
                            @csrf
                ...
                <div class="col-sm-auto ms-auto">
                    <div class="list-grid-nav hstack gap-1">
                        ...
                        <a href="{{ route('admin.managements.create') }}" class="btn btn-success addMembers-modal">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="live-preview">
                                ...
                                <tbody>
                                    @forelse ($managements as $item)
                                        <tr>
                                            ...
                                            <td><a href="{{ route('admin.managements.show', $item->id) }}">{{ $item->title }}</a></td>
                                            ...
                                            <td>
                                                ...
                                                <div class="dropdown d-inline-block">
                                                    ...
                                                    <ul class="dropdown-menu dropdown-menu-end" style="">
                                                        <li><a href="{{ route('admin.managements.show', $item->id) }}"
                                                                class="dropdown-item"><i
                                                                    class="ri-eye-fill align-bottom me-2 text-muted"></i>
                                                                    {{__('admin.btn_show')}}</a></li>
                                                        <li><a href="{{ route('admin.managements.edit', $item->id) }}"
                                            ...
                                            <div class="modal-dialog modal-dialog-scrollable" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-footer">
                                                        ...
                                                        <form
                                                            action="{{ route('admin.managements.destroy', $item->id) }}"
                                                            method="POST">
                                                            @csrf
                                                            @method('DELETE')
                        ...
                        @if ($managements->links()->paginator->hasPages())
                            {{ $managements->links() }}
                        @endif
                    </div>
                </div>
