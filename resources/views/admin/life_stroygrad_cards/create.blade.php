        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header align-items-center d-flex">
                    <h4 class="card-title mb-0 flex-grow-1">{{ __('admin.new_life_stroygrad_card_card_title') }}</h4>
                </div>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="live-preview">
                        <form action="{{ route('admin.blocks.life_stroygrad_card_store', $block_slug) }}" method="POST"
