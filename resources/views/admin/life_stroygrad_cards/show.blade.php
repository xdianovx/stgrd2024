...
@section('content')
    <div class="row">
        ...
        <div class="col-lg-8">
                ...
                <div class="card-body">
                    <div class="d-flex align-items-center mb-4">
                        <div class="flex-grow-1">
                            <h3 class="card-header align-items-center d-flex">{{ __('admin.life_stroygrad_card_card_title') }}:
                                {{ $item->title }}</h3>
                        </div>
                        <div class="flex-shrink-0">
                            <div class="dropdown">
                                ...
                                <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdownMenuLink1"
                                    ...
                                    <li><a href="{{ route('admin.blocks.life_stroygrad_card_edit', [$block_slug, $item]) }}"
            ...
            <div class="card">
                <div class="card-body">
                    <h5 class="card-header align-items-center d-flex">{{ __('admin.life_stroygrad_card_card_info') }}</h5>
                    <div class="table-responsive">
                        <table class="table table-borderless mb-0">
                            <tbody>
                                <tr>
                                    ...
                                    <div class="modal-dialog modal-dialog-scrollable" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <form
                                                    action="{{ route('admin.blocks.life_stroygrad_card_destroy', [$block_slug, $item]) }}"
                                                    method="POST">
                                                    @csrf
                                                    @method('DELETE')
