        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header align-items-center d-flex">
                    <h4 class="card-title mb-0 flex-grow-1">{{ __('admin.edit_project_image_card_title') }} {{ $item->type }}
                    </h4>
                </div>
            </div>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="live-preview">
                        <form action="{{ route('admin.projects.project_image_update', [$project_slug, $project_block_slug, $item]) }}" method="POST"
