        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header align-items-center d-flex">
                    <h4 class="card-title mb-0 flex-grow-1">{{__('admin.new_page_card_title')}}</h4>
                </div>
                            ...
                            <div class="row gy-4">
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea id="basic-default-message" class="form-control" name="text_right" placeholder="{{__('admin.placeholder_text')}}"
                                        style="height: 234px;">{{ old('text_right') }}</textarea>
                                </div>
                                <div class="mb-3">
                                    ...
                                    <textarea id="basic-default-message" class="form-control" name="text_left" placeholder="{{__('admin.placeholder_text')}}"
                                        style="height: 234px;">{{ old('text_left') }}</textarea>
                                </div>
                                <div class="mb-3">
