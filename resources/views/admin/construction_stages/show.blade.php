...
@section('content')
    <div class="row">
        ...
        <div class="col-lg-8">
                    ...
                    <div class="d-flex align-items-center mb-4">
                        <div class="flex-grow-1">
                            <h3 class="card-header align-items-center d-flex">
                                {{ __('admin.construction_stage_card_title') }}:
                                {{ $item->type }}</h3>
                        </div>
                        <div class="flex-shrink-0">
                            <div class="dropdown">
                                ...
                                <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdownMenuLink1"
                                    ...
                                    <li><a href="{{ route('admin.projects.construction_stage_edit', [$project_slug, $project_block_slug, $item]) }}"
            ...
            <div class="card">
                <div class="card-body">
                    <h5 class="card-header align-items-center d-flex">{{ __('admin.construction_stage_card_info') }}</h5>
                    <div class="table-responsive">
                        <table class="table table-borderless mb-0">
                            <tbody>
                                ...
                                <tr>
                                    <th class="ps-0" scope="row">{{ __('admin.field_date') }}</th>
                                    ...
                                    <div class="modal-dialog modal-dialog-scrollable" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <form
                                                    action="{{ route('admin.projects.construction_stage_destroy', [$project_slug, $project_block_slug, $item]) }}"
                                                    method="POST">
                                                    @csrf
                                                    @method('DELETE')
