                ...
                <div class="card-body">
                    <div class="d-flex align-items-center mb-4">
                        <div class="flex-grow-1">
                            <h3 class="card-header align-items-center d-flex">{{ __('admin.vacanci_card_title') }}:
                                {{ $item->title }}</h3>
                        </div>
                        <div class="flex-shrink-0">
                            <div class="dropdown">
                                ...
                                <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdownMenuLink1"
                                    ...
                                    <li><a href="{{ route('admin.vacancies.edit', $item->slug) }}"
                    ...
                    @if ($item->duties)
                        <h5 class="text-muted">{{ __('admin.field_duties') }}:</h5>
                        <div class="table-responsive">
                            <table class="table table-borderless mb-0">
                                <tbody>
                                    <tr>
                                        <td class="text-muted">{!! $item->duties !!}</td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
                    ...
                    @endif
                    @if ($item->terms)
                        <h5 class="text-muted">{{ __('admin.field_terms') }}:</h5>
                        <div class="table-responsive">
                            <table class="table table-borderless mb-0">
                                <tbody>
                                    <tr>
                                        <td class="text-muted">{!! $item->terms !!}</td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
                    ...
                    @endif
                    @if ($item->reqs)
                        <h5 class="text-muted">{{ __('admin.field_reqs') }}:</h5>
                        <div class="table-responsive">
                            <table class="table table-borderless mb-0">
                                <tbody>
                                    <tr>
                                        <td class="text-muted">{!! $item->reqs !!}</td>
                                    </tr>
                                </tbody>
                            </table>
                        </div>
                    ...
                    <div class="table-responsive">
                        <table class="table table-borderless mb-0">
                            <tbody>
                                ...
                                <tr>
                                    <th class="ps-0" scope="row">{{ __('admin.field_exp') }}:</th>
                                    <td class="text-muted">{{ $item->expirience }}</td>
                                </tr>
                                <tr>
                                    ...
                                    <div class="modal-dialog modal-dialog-scrollable" role="document">
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-footer">
                                                ...
                                                <form action="{{ route('admin.vacancies.destroy', $item->slug) }}"
                                                    method="POST">
                                                    @csrf
                                                    @method('DELETE')
