        ...
        <div class="col-lg-12">
            <div class="card">
                <div class="card-header align-items-center d-flex">
                    <h4 class="card-title mb-0 flex-grow-1">{{__('admin.edit_vacanci_card_title')}} {{ $item->title }}</h4>
                            ...
                            <div class="row gy-4">
                                ...
                                <div class="col-xxl-6 col-md-6">
                                    <div>
                                        ...
                                        <input type="text" value="{{ $item->expirience }}" class="form-control"
                                            id="expirienceInput" name="expirience" placeholder="{{__('admin.placeholder_text')}}">
                                    </div>
                                ...
                                <div class="col-xxl-6 col-md-6">
                                    <div>
                                        ...
                                        <input type="text" value="{{ $item->salary }}" class="form-control"
                                            id="salaryInput" name="salary" placeholder="{{__('admin.placeholder_text')}}">
                                    </div>
                                ...
                                <div class="col-xxl-12 col-md-12">
                                    <div>
                                        ...
                                        <textarea class="form-control" id="editor" name="terms" rows="3">{{ $item->terms }}</textarea>
                                    </div>
                                ...
                                <div class="col-xxl-12 col-md-12">
                                    <div>
                                        ...
                                        <textarea class="form-control" id="editor" name="reqs" rows="3">{{ $item->reqs }}</textarea>
                                    </div>
