                            ...
                            <div class="row gy-4">
                              ...
                              <div class="col-xxl-6 col-md-6">
                                ...
                                <div class="col-xxl-12">
                                    <div>
                                        <label for="dutiesInput" class="form-label">{{ __('admin.field_duties') }}
                                            *</label>
                                        <textarea class="form-control" id="editor" name="duties" placeholder="{{ __('admin.placeholder_text') }}">{{ old('duties') }}</textarea>
                                    </div>
                                </div>
                                <div class="col-xxl-12">
                                    <div>
                                        <label for="termsInput" class="form-label">{{ __('admin.field_terms') }} *</label>
                                        <textarea class="form-control" id="editor" name="terms" placeholder="{{ __('admin.placeholder_text') }}">{{ old('terms') }}</textarea>
                                    </div>
                                </div>
                                <div class="col-xxl-12">
                                    <div>
                                        <label for="reqsInput" class="form-label">{{ __('admin.field_reqs') }} *</label>
                                        <textarea class="form-control" id="editor" name="reqs" placeholder="{{ __('admin.placeholder_text') }}">{{ old('reqs') }}</textarea>
                                    </div>
                                </div>
