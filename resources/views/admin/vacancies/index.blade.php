            ...
            <div class="row g-2">
                <div class="col-sm-4">
                    <div class="search-box">
                        <form class="d-flex" action="{{ route('admin.vacancies.search') }}" method="get">
                            @csrf
                ...
                <div class="col-sm-auto ms-auto">
                    <div class="list-grid-nav hstack gap-1">
                        ...
                        <a href="{{ route('admin.vacancies.create') }}" class="btn btn-success addMembers-modal">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="live-preview">
                            ...
                            <table class="table align-middle table-nowrap mb-0">
                                ...
                                <tbody>
                                    @forelse ($vacancies as $item)
                                        <tr>
                                            <td>{{ $item->id }}</td>
                                            <td><a href="{{ route('admin.vacancies.show', $item->slug) }}">{{ $item->title }}</a></td>
                                            <td>{{ $item->slug }}</td>
                                            ...
                                            <td>
                                                ...
                                                <div class="dropdown d-inline-block">
                                                    ...
                                                    <ul class="dropdown-menu dropdown-menu-end" style="">
                                                        <li><a href="{{ route('admin.vacancies.show', $item->slug) }}"
                                            ...
                                            <div class="modal-dialog modal-dialog-scrollable" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-footer">
                                                        ...
                                                        <form
                                                            action="{{ route('admin.vacancies.destroy', $item->slug) }}"
                                                            method="POST">
                                                            @csrf
                                                            @method('DELETE')
                        ...
                        @if ($vacancies->links()->paginator->hasPages())
                            {{ $vacancies->links() }}
                        @endif
                    </div>
                </div>
