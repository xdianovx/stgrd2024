                            ...
                            <div class="select-list">
                                <div class="select-list__wrap">
                                    @foreach ($cities as $city)
                                        <div class="select-item-city" data-city="{{ $city['slug'] }}">{{ $city['title'] }}
                                        </div>
                                    @endforeach
                                </div>
                            </div>
                            ...
                            <div class="select-list">
                                <div class="select-list__wrap">
                                    @foreach ($statuses as $status)
                                        <div class="select-item-status" data-status="{{ $status['slug'] }}">
                                            {{ $status['title'] }}</div>
                                    @endforeach
                                </div>
                            </div>
                            ...
                            <div class="select-list">
                                <div class="select-list__wrap">
                                    @foreach ($projects_planning_solutions as $price)
                                        <div class="select-item-price" data-price="{{ $price }}">от
                                            {{ $price }} млн. руб.</div>
                                    @endforeach
                                </div>
                            </div>
                    ...
                    <div class="projects-page-catalog__big_card">
                        ...
                        <div class="projects-page-catalog__big_card_info">
                            ...
                            <div class="projects-page-catalog__big_card_col">
                                ...
                                <p class="projects-page-catalog__big_card_col_deadline">Год сдачи
                                    {{ $project_home->year_delivery }}</p>
                            </div>
                            <div class="projects-page-catalog__big_card_text">{!! $project_home->description !!}</div>
                            <p class="projects-page-catalog__big_card_link">
                                <x-ui.link href="{{ $project_home->link }}">от
                                    {{ $project_home->planningSolutions->min('price') }} млн. руб.</x-ui.link>
                            </p>
                        </div>
                    </div>
                @endforeach
                                                ...
                                                <div class="filter__content_inner">
                                                    @foreach ($item->planningSolutions as $planningSolution)
                                                        <div class="filter__content_item">
                                                            <div class="filter__content_item_type">
                                                                {{ $planningSolution['number_rooms'] }}</div>
                                                            <div class="filter__content_item_square">от
                                                                {{ $planningSolution['number_square_meters'] }}м²</div>
                                                            <x-ui.link href="{{ $item->link }}">от
                                                                {{ $planningSolution['price'] }} млн. руб.</x-ui.link>
                                                        </div>
                                                    @endforeach
                                                </div>
                                            </div>
